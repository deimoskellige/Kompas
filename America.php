...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=no">
    ...
    <link rel="stylesheet" href="css/trips-shared.css" type="text/css" />
...
<body>
    ...
    <main>
        ...
        <div class="first">
            ...
            <div class="AMERICA continant">
                <p>AMERICA</p>
            </div>

            <div class="citation">
                <p data-aos="fade-left" class="phrase phrase-america">“Adventure is worthwhile.” </p>
                <p data-aos="fade-right" class="auteur">Aesop</p>
            </div>
        ...
        <!-----------------------------FIRST TRAVEL----------------------------------- -->
        <div class="second">
        <?php  $products = $DB->query('SELECT DISTINCT * FROM products WHERE continant IN ("America")'); ?>
