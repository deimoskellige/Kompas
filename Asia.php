...
<body>
    ...
    <main>
        ...
        <div class="first">
            ...
            <div data-aos="fade-in" class="ASIA continant">
                <p data-aos="fade-in" data-aos-delay="500">ASIA</p>
            </div>

            <div class="citation">
                <p data-aos="fade-left" data-aos-delay="500" class="phrase">“It is not power that corrupts but fear.”</p>
                <p data-aos="fade-right" data-aos-delay="500" class="auteur">Aung San Suu Kyi</p>
            </div>
        ...
        <!-----------------------------FIRST TRAVEL----------------------------------- -->
        <div class="second">
        <?php  $products = $DB->query('SELECT DISTINCT * FROM products WHERE continant IN ("Asia")'); ?>
